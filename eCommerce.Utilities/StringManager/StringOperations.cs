...
namespace eCommerce.Utilities.StringManager
{
    public class StringOperations
    {
        /// <summary>
        /// String içerisindeki karakterleri seo ya uygun olarak çevirir.
        /// Örn; "AliRıza Adıyahşi" -> "aliriza-adiyahsi"
        /// </summary>
        /// <param name="IncomingText">Çevrilecek string</param>
        /// <returns>Çevrilen string</returns>
        public static string ToSeoFriendlyString(string IncomingText)
        {
